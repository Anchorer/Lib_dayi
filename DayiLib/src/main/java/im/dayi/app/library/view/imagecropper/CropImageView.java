...
package im.dayi.app.library.view.imagecropper;
...
import im.dayi.app.library.view.imagecropper.cropwindow.CropOverlayView;
import im.dayi.app.library.view.imagecropper.cropwindow.edge.Edge;
import im.dayi.app.library.view.imagecropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
	...
	public Bitmap getCroppedImage() {
		...
		int actualCropX = (int) (cropWindowX * scaleFactorWidth);
		int actualCropY = (int) (cropWindowY * scaleFactorHeight);
		int actualCropWidth = (int) (cropWindowWidth * scaleFactorWidth);
		int actualCropHeight = (int) (cropWindowHeight * scaleFactorHeight);
        ...
        try {
            croppedBitmap = Bitmap.createBitmap(mBitmap, actualCropX, actualCropY, actualCropWidth, actualCropHeight);
	...
	private void init(Context context) {
		...
		final View v = inflater.inflate(R.layout.widget_crop_image_view, this, true);
