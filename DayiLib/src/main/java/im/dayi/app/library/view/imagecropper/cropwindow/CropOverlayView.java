...
package im.dayi.app.library.view.imagecropper.cropwindow;
...
import im.dayi.app.library.view.imagecropper.CropImageView;
import im.dayi.app.library.view.imagecropper.cropwindow.edge.Edge;
import im.dayi.app.library.view.imagecropper.cropwindow.handle.Handle;
import im.dayi.app.library.view.imagecropper.util.AspectRatioUtil;
import im.dayi.app.library.view.imagecropper.util.HandleUtil;
import im.dayi.app.library.view.imagecropper.util.PaintUtil;
...
//            final float verticalPadding = 0.1f * bitmapRect.height();
            ...
            //update by wragony on 2014-03-28
            final float horizontalPadding = 5f;
            final float verticalPadding = 10f;
